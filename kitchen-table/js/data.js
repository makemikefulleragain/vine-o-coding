...
export const TASKS = [
  ...
  {id:"t9",text:"International AI speaker — research + prep",detail:"Her speaking topics, community size, location.\n\nAngles: she delivers workshops (rev share), coders contribute to Vine-o-Code, joint speaking, Tier 1 ally.",phase:"p1",pri:"high",tags:["meeting","outreach","today"],done:true},
  ...
  {id:"t14",text:"Create Anthropic API account + set $50/mo cap",detail:"api.anthropic.com. Sonnet for Kai (speed + cost). 100 convos/day < $50/month estimate.",phase:"p1",pri:"normal",tags:["build","today"],done:true},
