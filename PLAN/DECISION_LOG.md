...
| 2026-02-20 | Sovereignty Calculator + Copilot Check promoted to kamunity.org encounter cards | Tools existed as local Kitchen Table standalone pages. Promoted to full Next.js pages on kamunity.org (/calculator, /copilot-check) + Kai card registry. Kai now surfaces them when conversations warrant — the "holy shit moment" for ALIKE. | kamunity-org/src/app/, kai-cards.ts, route.ts |
