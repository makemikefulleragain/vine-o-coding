  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p className="text-xs text-slate-300 text-center mt-4 pt-4 border-t border-slate-200">
          Vine-o-Code is a community methodology, not a certified professional service. Tools built with it should be reviewed before handling sensitive data. Consult a qualified professional for legal, financial, or safety matters.
        </p>
      </div>
    </footer>
  )
